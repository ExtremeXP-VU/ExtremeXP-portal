...
class WorkflowHandler(object):
    ...
    def workflow_exists(self, exp_id):
    ...
    def delete_workflow(self, exp_id, proj_id):
        query = {"id_experiment": exp_id}
    ...
    def update_workflow_name(self, exp_id, proj_id, exp_name):
    ...
    def update_workflow_graphical_model(self, exp_id, proj_id, graphical_model):
        update_time = calendar.timegm(time.gmtime())
        query = {"id_experiment": exp_id}
        new_values = {
